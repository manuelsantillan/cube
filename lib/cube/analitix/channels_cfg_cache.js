...
exports.initCache=function(db){
    ...
    collection("configuration").events.distinct("d.station.daqId", function(err, daqList){
        if(err){
        ...
        _.each(daqList, function(daqId){
            collection("configuration").events.find({"d.station.daqId" :daqId },options, function(err, cursor){
...
exports.findChannelCfg=function(channelId){
    ...
    _.each(exports.getCache(), function(daqCfg){
        ...
        if(daqCfg.station.daqId == daqId){
            channelCfg = _.find(daqCfg.station.channels, function(channel){
                if(channel.identification.id == channelNumber){
                    return channel;
                }
            });
            return channelCfg;
...
exports.replace=function(daqCfg){
    ...
    _.each(exports.getCache(), function(daqCfgOld, index){
        console.log(daqCfg)
        if(daqCfgOld.station.daqId == daqCfg.station.daqId){
            found=true;
