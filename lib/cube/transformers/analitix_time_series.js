...
exports.enrichEvent=function(event){
    ...
    if (channelCfg){
        event.body.metadata.name = channelCfg.generalChannel.name;
        event.body.metadata.shortDesc = channelCfg.generalChannel.shortDesc;
        event.body.metadata.unitOfMeasurement =  channelCfg.generalChannel.unitOfMeasurement;
        event.body.metadata.channelType =  channelCfg.generalChannel.channelType;
        event.body.metadata.channelNumber =  channelCfg.generalChannel.channelNumber;
